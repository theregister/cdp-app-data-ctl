...
echo "source ../env/shell/env.set.db.marsol.sh"
echo ""
echo "run this script to set marsol password"
echo "source ~/MyFiles/MyProjects/helper-secrets/env/env.set.alloydb.pw.sh"
