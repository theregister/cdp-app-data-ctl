...
echo ""
echo "run this script to set marsol parameters"
echo "source $SCC_DATA_HOME_ENV/shell/env.set.db.alloy.sitpub.marsol.sh"
echo ""
echo "SET alloydb.sitpub.marsol password"
echo "source ~/MyFiles/MyProjects/helper-secrets/env/env.set.alloydb.sitpub.marsol.pw.sh"
