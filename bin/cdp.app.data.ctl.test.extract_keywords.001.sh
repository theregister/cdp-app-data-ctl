...
cdp.data.ctl.sh process extract-keywords-from-assets
...
#cdp.data.ctl.sh process match_classification_to_taxonomy
...
# now make sure ONE version of the extraction results are made PUBLISHED in cdp_data_asset_classification
...
# cdp.data.ctl.sh build asset_classifiction_taxonomy_map
# inputs
# - classification_version

# now take asset_taxonomy_map and score transactions on it.
#cdp.data.ctl.sh score_transactions - input asset_taxonomy_map
