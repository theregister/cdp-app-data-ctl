...
export CDP_APP_DATA_CTL_HOME=$PROJECT_DIR
...
export CDP_APP_DATA_CTL_DB_NAME=cdp_data_001

export CDP_APP_DATA_CTL_GIT_SSH_ALIAS=
...
# GCP Variables
export CDP_APP_DATA_CTL_GCP_TUNNEL_PORT=
