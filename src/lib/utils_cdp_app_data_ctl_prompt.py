...
def get_prompt_text_campaign_insights(prompt_type, prompt_name, project_leads_df):
    ...
    campaign_insights_20250528_01 = f"""
        ...
        1. section name - 1. Executive Summary - a brief overview of the campaign performance, highlighting key metrics and outcomes.
        2. section name - 2. Asset Analysis - An analysis of the assets that were most effective in generating leads.
        3. section name - 3. Job Function Analysis - An analysis of the job functions that responded
        4. section name - 4. Asset/Job Function Analysis - An analysis of any correlations between the assets and the job functions that responded.
